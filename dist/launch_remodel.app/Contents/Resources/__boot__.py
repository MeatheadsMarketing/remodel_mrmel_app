...
_recipes_pil_prescript(['MpoImagePlugin', 'TgaImagePlugin', 'XVThumbImagePlugin', 'PngImagePlugin', 'ImImagePlugin', 'TiffImagePlugin', 'DdsImagePlugin', 'McIdasImagePlugin', 'MpegImagePlugin', 'BufrStubImagePlugin', 'XpmImagePlugin', 'PdfImagePlugin', 'DcxImagePlugin', 'FtexImagePlugin', 'WmfImagePlugin', 'BmpImagePlugin', 'IcnsImagePlugin', 'SgiImagePlugin', 'ImtImagePlugin', 'JpegImagePlugin', 'FpxImagePlugin', 'SunImagePlugin', 'IcoImagePlugin', 'Jpeg2KImagePlugin', 'PsdImagePlugin', 'EpsImagePlugin', 'BlpImagePlugin', 'SpiderImagePlugin', 'WebPImagePlugin', 'PcdImagePlugin', 'GribStubImagePlugin', 'PpmImagePlugin', 'MicImagePlugin', 'CurImagePlugin', 'Hdf5StubImagePlugin', 'XbmImagePlugin', 'FitsImagePlugin', 'PixarImagePlugin', 'MspImagePlugin', 'GbrImagePlugin', 'PcxImagePlugin', 'PalmImagePlugin', 'QoiImagePlugin', 'FliImagePlugin', 'IptcImagePlugin', 'GifImagePlugin'])
...
DEFAULT_SCRIPT='launch_remodel.py'
SCRIPT_MAP={}
_run()
